  ...
  if (callState.isActive) {
    ...
    return (
      <>
        ...
        <div className="fixed z-50 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[90vw] max-w-[400px] bg-gray-900 rounded-3xl border border-white/10 shadow-2xl overflow-hidden">
