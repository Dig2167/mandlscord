  ...
  const startJitsiCall = useCallback(async (
    ...
    const options = {
      ...
      configOverwrite: {
        ...
        defaultLanguage: 'ru',
        resolution: isVideo ? 480 : undefined,
        constraints: {
          video: {
            height: { ideal: isVideo ? 480 : 240, max: isVideo ? 720 : 480 },
            width: { ideal: isVideo ? 640 : 320, max: isVideo ? 1280 : 640 },
            frameRate: { ideal: isVideo ? 15 : 10, max: isVideo ? 20 : 15 }
          }
        },
        enableLayerSuspension: true,
        maxFullResolutionParticipants: isVideo ? 2 : 0,
        channelLastN: isVideo ? 4 : 1,
        disableAudioLevels: true,
        startBitrate: isVideo ? '300' : '50',
        ...
        opusMaxAverageBitrate: isVideo ? 32000 : 16000,
        opusStereo: false,
        opusFec: true,
        opusDtx: true
      },
